...
const sidebar_items_1 = [
  ...
  {
    display_name: "Sản phẩm đang bán",
    route: "/products",
    add: "/add-product",
  ...
  {
    display_name: "Sản phẩm dừng bán",
    route: "/products-close",
    add: "/add-product",
    modify: "/product-detail",
    icon: "bx bx-package",
  },
  ...
  {
    display_name: "Quản lí Loại sản phẩm",
    route: "/categories",
    add: "/add-category",
  ...
  {
    display_name: "Quản lí Khuyến mãi",
    route: "/sale",
    add: "/add-sale",
    modify: "/sale-detail",
    icon: "bx bx-gift",
  ...
  {
    display_name: "Quản lí Thương hiệu",
    route: "/brand",
    add: "/add-brand",
    modify: "/brand-detail",
...
const Sidebar = (props) => {
  const sidebar_items =
    props.user.roleName === "ADMIN" ? sidebar_items_1 : sidebar_items_2;
  useEffect(() => {
